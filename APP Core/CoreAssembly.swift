...
final public class CoreAssembly {
    ...
    public private(set) lazy var featureAssembly = FeaturedAssembly(imageLoadingAssembly: imageLoadingAssembly, detailAssembly: detailsAssembly, searchAssembly: searchAssembly)
